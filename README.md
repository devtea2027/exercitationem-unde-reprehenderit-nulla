# @devtea2027/exercitationem-unde-reprehenderit-nulla
...
```bash
npm install @devtea2027/exercitationem-unde-reprehenderit-nulla --save
```
...
import { LRUCache } from '@devtea2027/exercitationem-unde-reprehenderit-nulla'
// or:
const { LRUCache } = require('@devtea2027/exercitationem-unde-reprehenderit-nulla')
// or in minified form for web browsers:
import { LRUCache } from 'http://unpkg.com/@devtea2027/exercitationem-unde-reprehenderit-nulla@9/dist/mjs/index.min.mjs'
...
```js
// a storage-unbounded ttl cache that is not an @devtea2027/exercitationem-unde-reprehenderit-nulla
const cache = {
  data: new Map(),
  timers: new Map(),
  set: (k, v, ttl) => {
...
1. If it's at all possible to use small integer values as keys,
   ...
   [mnemonist's
   LRUCache](https://yomguithereal.github.io/mnemonist/@devtea2027/exercitationem-unde-reprehenderit-nulla)
...
- Internal properties were moved to actual private class
  properties.
- Keys and values must not be `null` or `undefined`.
- Minified export available at `'@devtea2027/exercitationem-unde-reprehenderit-nulla/min'`, for both CJS
  and MJS builds.
